...
import 'package:sanad_therapists/main.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  bool _notificationsEnabled = true; // Example state for notifications
  String? _image;
                ...
                child: CircleAvatar(
                  ...
                  child: ClipOval(
                    child: DatabaseService.me.image != null &&
                        ...
                        : Icon(Icons.person,
                            size:
                                40), // Show icon if image URL is null or empty
                  ),
                ),
              ),
            ),
