...
import 'package:sanad_therapists/services/share_preference.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      providers: [
        BlocProvider(create: (context) =>  PatientListCubit()),
      ],
      child: MaterialApp(
        ...
        initialRoute: _authService.user != null ? "/main" : "/login",
